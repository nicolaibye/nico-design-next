    ...
    <>
      <div>
        ...
        <button
          ...
          className="z-999 fixed top-6 sm:top-19 left-19.5 sm:left-6 w-8 h-8 p-1.5 mix-blend-difference outline-2 outline-white-LinkWater rounded-full flex items-center overflow-hidden"
        >
          <SunIcon
            ref={sunRef}
            size={24}
