          ...
          {projects.map((project) => (
            ...
            >
              ...
              >
                ...
                <div className="absolute w-54 sm:w-65 lg:w-60 lg:group-hover:w-125 -bottom-5 -right-24 sm:-bottom-13 sm:-right-10 lg:right-1/2 lg:translate-x-1/2 lg:bottom-[10%] rotate-[-20deg] lg:group-hover:rotate-5">
